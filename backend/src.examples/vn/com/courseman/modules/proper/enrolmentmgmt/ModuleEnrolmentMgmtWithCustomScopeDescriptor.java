...
import domainapp.basics.model.meta.module.containment.CEdge;
import domainapp.basics.model.meta.module.containment.CTree;
import domainapp.basics.model.meta.module.containment.ScopeDesc;
...
import domainapp.basics.view.datafields.JLabelField;
...
/**
 * @overview Supports descendant module configuration. 
 *
      ...
      edges={
        ...
        scopeDesc=@ScopeDesc(
            ...
            ,attribDescs={
               ...
               @AttributeDesc(id="id", type=JLabelField.class),
               @AttributeDesc(id="name", type=JLabelField.class, editable=false),
            }
            ))}
       )
    ,isPrimary=true,
...
public class ModuleEnrolmentMgmtWithCustomScopeDescriptor {
