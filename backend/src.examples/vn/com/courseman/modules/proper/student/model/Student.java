package vn.com.courseman.modules.proper.student.model;
...
import vn.com.courseman.modules.proper.enrolment.model.Enrolment;
...
public class Student{
  ...
  @DAttr(name = "sclasses", type = Type.Collection, serialisable = false, filter = @Select(clazz = SClassRegistration.class))
  @DAssoc(ascName = "M1-m-assoc-M2", role = "r1", ascType = AssocType.Many2Many, endType = AssocEndType.Many, associate = @Associate(type = SClass.class, cardMin = 0, cardMax = MetaConstants.CARD_MORE), normAttrib = "classRegists")
  ...
  @DAssoc(ascName = "M1-assoc-I", role = "r1", ascType = AssocType.One2Many, endType = AssocEndType.One, associate = @Associate(type = SClassRegistration.class, cardMin = 0, cardMax = MetaConstants.CARD_MORE))
  ...
  @DAttr(name=A_modules,type=Type.Collection,serialisable=false,
      filter=@Select(clazz=CourseModule.class))
  @DAssoc(ascName="enrols-in",role="std",
    ascType=AssocType.Many2Many,endType=AssocEndType.Many,
    associate=@Associate(type=CourseModule.class,cardMin=0,cardMax=MetaConstants.CARD_MORE),
