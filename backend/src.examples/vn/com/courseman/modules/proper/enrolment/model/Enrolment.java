package vn.com.courseman.modules.proper.enrolment.model;
...
public class Enrolment {
  ...
  @DAssoc(ascName="std-has-enrols",role="enr",
  ...
  @DAssoc(ascName="mod-has-enrols",role="enr",
      ascType=AssocType.One2Many,endType=AssocEndType.Many,
  ...
  @DAttr(name="finalGrade",type=Type.Char,length=1,auto=true,mutable=false,optional=true
