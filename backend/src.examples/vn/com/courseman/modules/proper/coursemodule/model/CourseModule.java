package vn.com.courseman.modules.proper.coursemodule.model;
...
public class CourseModule {
  ...
  @DAssoc(ascName="enrols-in",role="mod",
  ...
  @DAssoc(ascName="mod-has-enrols",role="mod",
  ...
  @DOpt(type=DOpt.Type.DataSourceConstructor) // no students
  public CourseModule(Integer id, String code, String name, Integer semester, Integer credits) {
    this(id, code, name, semester, credits, null);
  }
  ...
  // used ONLY if students are added to course modules via many-many association
  @DOpt(type=DOpt.Type.ObjectFormConstructor)
  public CourseModule(String name, Integer semester, Integer credits, Collection<Student> students) {
    this(null, null, name, semester, credits, students);
  }
  ...
  /** ASSOCIATION {@link #students}: maintained via {@link #enrolments} */
  ...
  /**
   * @effects 
   *  add <tt>std</tt> to {@link #students}
   */
  ...
  /**
   * @effects 
   *  remove <tt>std</tt> to {@link #students}
   */
  private void removeStudent(Student std) {
    if (students != null) {
      students.remove(std);
    }
  }
  
  /** end ASSOCIATION {@link #students}*/
