...
<Col md={7} className='px-0'>
  ...
  currentId={this.props.current.address?.id}
  ...
  handleUnlink={() =>
    this.props.handleStateChange("current.address", null, false,
      this.props.handleStateChange("current.id", ""))} /></FormGroup></> }
<br />
<FormGroup>
...
<br />
{this.props.excludes && this.props.excludes.includes("enrolment") ? "" : <>
<EnrolmentSubmodule
  mode='submodule'
  viewType={this.props.viewType}
  title="Form: Enrolment"
  current={this.props.current.enrolments}
  parentName='enrolment' parent='enrolment'
  parentId={this.props.currentId}
  parentAPI={this.props.mainAPI}
  partialApplyWithCallbacks={this.partialApplyWithCallbacks} /></>}
</>);
